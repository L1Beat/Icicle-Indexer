...
INSERT INTO stablecoins (chain_id, token, symbol, name, decimals, peg, issuer, bridged, added_at) VALUES
    ...
    (43114, unhex('9ee1963f05553ef838604dd39403be21cef26aa4'), 'USDp',   'Parallel USD',                 18, 'USD', 'Parallel',          false, '2026-01-01 00:00:00'),
    (43114, unhex('d24c2ad096400b6fbcd2ad8b24e7acbc21a1da64'), 'FRAX',   'Frax',                         18, 'USD', 'Frax',              false, '2026-01-01 00:00:00'),
    (43114, unhex('abe7a9dfda35230ff60d1590a929ae0644c47dc1'), 'aUSD',   'Stable Jack aUSD',             18, 'USD', 'Stable Jack',       false, '2026-01-01 00:00:00'),
    (43114, unhex('9f6714c302ffe3c3bafaf2ccb44201ff64f6371c'), 'FUSD',   'FinChain Dollar',              18, 'USD', 'FinChain',          false, '2026-01-01 00:00:00'),
    (43114, unhex('80eede496655fb9047dd39d9f418d5483ed600df'), 'FRXUSD', 'Frax USD',                     18, 'USD', 'Frax',              false, '2026-01-01 00:00:00'),
    (43114, unhex('5d3a1ff2b6bab83b63cd9ad0787074081a52ef34'), 'USDe',   'Ethena USDe',                  18, 'USD', 'Ethena',            false, '2026-01-01 00:00:00'),
    (43114, unhex('cfc37a6ab183dd4aed08c204d1c2773c0b1bdf46'), 'NUSD',   'Nexus USD',                    18, 'USD', 'Nexus',             false, '2026-01-01 00:00:00'),
    (43114, unhex('025ab35ff6abcca56d57475249baaeae08419039'), 'ARUSD',  'arUSD',                        18, 'USD', '',                  false, '2026-01-01 00:00:00'),
    (43114, unhex('221743dc9e954be4f86844649bf19b43d6f8366d'), 'DOLA',   'Dola',                         18, 'USD', 'Inverse Finance',   false, '2026-01-01 00:00:00'),
    (43114, unhex('323665443cef804a3b5206103304bd4872ea4253'), 'USDV',   'Verified USD',                  6, 'USD', 'Verified',          false, '2026-01-01 00:00:00'),
    (43114, unhex('853ea32391aaa14c112c645fd20ba389ab25c5e0'), 'USX',    'dForce USD',                   18, 'USD', 'dForce',            false, '2026-01-01 00:00:00'),
    (43114, unhex('e80772eaf6e2e18b651f160bc9158b2a5cafca65'), 'USD+',   'USD+',                          6, 'USD', 'Overnight',         false, '2026-01-01 00:00:00'),
    (43114, unhex('0f577433bf59560ef2a79c124e9ff99fca258948'), 'MONEY',  'Moremoney USD',                18, 'USD', 'Moremoney',         false, '2026-01-01 00:00:00'),
    (43114, unhex('f9fb20b8e097904f0ab7d12e9dbee88f2dcd0f16'), 'SBC',    'Stable Coin',                  18, 'USD', '',                  false, '2026-01-01 00:00:00'),
    (43114, unhex('09056fc62d9e1cff4bb5ceac4d7be6f420450647'), 'PYUSD',  'PayPal USD',                    6, 'USD', 'PayPal',            false, '2026-01-01 00:00:00'),
    (43114, unhex('03569cc076654f82679c4ba2124d64774781b01d'), 'BOLD',   'Liquity BOLD',                 18, 'USD', 'Liquity',           false, '2026-01-01 00:00:00'),
    (43114, unhex('dbdd50997361522495ecfe57ebb6850da0e4c699'), 'BNUSD',  'Balanced Dollars',             18, 'USD', 'Balanced',          false, '2026-01-01 00:00:00'),
    (43114, unhex('cc18b41a0f63c67f17f23388c848aec67b583422'), 'xpUSD',  'Gaming XP USD',                 6, 'USD', '',                  false, '2026-01-01 00:00:00'),
    (43114, unhex('7dc9748da8e762e569f9269f48f69a1a9f8ea761'), 'ZeUSD',  'Zoth ZeUSD',                    6, 'USD', 'Zoth',              false, '2026-01-01 00:00:00'),
    (43114, unhex('da0019e7e50ee4990440b1aa5dffcac6e27ee27b'), 'LUSD',   'Liquity USD',                  18, 'USD', 'Liquity',           false, '2026-01-01 00:00:00'),
    (43114, unhex('0000206329b97db379d5e1bf586bbdb969c63274'), 'USDA',   'USDA',                         18, 'USD', 'Angle',             false, '2026-01-01 00:00:00'),
    (43114, unhex('e08b4c1005603427420e64252a8b120cace4d122'), 'BENJI',  'Franklin OnChain U.S. Government Money Fund', 18, 'USD', 'Franklin Templeton', false, '2026-01-01 00:00:00'),
    (43114, unhex('b57b25851fe2311cc3fe511c8f10e868932e0680'), 'deUSD',  'Elixir deUSD',                 18, 'USD', 'Elixir',            false, '2026-01-01 00:00:00'),
    (43114, unhex('564a341df6c126f90cf3ecb92120fd7190acb401'), 'TRYB',   'BiLira',                        6, 'TRY', 'BiLira',            false, '2026-01-01 00:00:00'),
    (43114, unhex('228a48df6819ccc2eca01e2192ebafffdad56c19'), 'VCHF',   'VNX Swiss Franc',              18, 'CHF', 'VNX',               false, '2026-01-01 00:00:00'),
    (43114, unhex('8835a2f66a7aaccb297cb985831a616b75e2e16c'), 'EUROP',  'Schuman EUROP',                 6, 'EUR', 'Schuman',           false, '2026-01-01 00:00:00'),
    (43114, unhex('7678e162f38ec9ef2bfd1d0aaf9fd93355e5fa0b'), 'VEUR',   'VNX Euro',                     18, 'EUR', 'VNX',               false, '2026-01-01 00:00:00'),
    (43114, unhex('05539f021b66fd01d1fb1ff8e167cdd09bf7c2d0'), 'BRZ',    'Brazilian Digital',            18, 'BRL', 'Transfero',         false, '2026-01-01 00:00:00'),
    (43114, unhex('27f6c8289550fce67f6b50bed1f519966afe5287'), 'tGBP',   'Tokenised GBP',                18, 'GBP', '',                  false, '2026-01-01 00:00:00'),
    (43114, unhex('820802fa8a99901f52e39acd21177b0be6ee2974'), 'EUROe',  'EUROe Stablecoin',              6, 'EUR', 'Membrane',          false, '2026-01-01 00:00:00');
